...
**第一次接触 Python？** `python_tutorial/` 文件夹（🚧 开发中）将提供一套专门为本项目定制的 Python 入门教程，内容紧贴经济/金融实证场景，学完就能直接用本项目的代码。

> 📢 **当前状态：立项规划中，Notebook 尚未上传。** 可先查看 `python_tutorial/README.md` 了解课程规划，持续关注更新。

```text
python_tutorial/
├── README.md                                    # 课程规划与学习路线（已上传）
├── P00_写在前面_如何使用本教程.ipynb            # 🚧 待开发
├── P01_Python基础_变量与数据类型.ipynb          # 🚧 待开发
├── P02_Python基础_条件与循环.ipynb              # 🚧 待开发
├── P03_Python基础_函数与模块.ipynb              # 🚧 待开发
├── P04_数据处理_NumPy数组.ipynb                 # 🚧 待开发
├── P05_数据处理_Pandas表格操作.ipynb            # 🚧 待开发
├── P06_数据可视化_Matplotlib画图.ipynb          # 🚧 待开发
├── P07_统计基础_描述性统计与假设检验.ipynb       # 🚧 待开发
└── P08_实战演练_用Python复现一篇实证论文.ipynb   # 🚧 待开发
```
...
```text
EconometricsML/
├── python_tutorial/             # 🚧 Python 入门教程（专为本项目定制，新手必看，开发中）
│   ├── README.md                    # 教程导读与学习路线图
│   ├── P00_写在前面_如何使用本教程.ipynb       # 🚧 待开发
│   ├── P01_Python基础_变量与数据类型.ipynb     # 🚧 待开发
│   ├── P02_Python基础_条件与循环.ipynb         # 🚧 待开发
│   ├── P03_Python基础_函数与模块.ipynb         # 🚧 待开发
...
| `traditional/logit.py` | `stata/traditional/03_logit_probit.do` | ✅ 完整 |
| `traditional/iv.py` | `stata/traditional/02_iv_2sls.do` | ✅ 完整 |
| `traditional/panel.py` | `stata/traditional/04_panel_fe_re.do` | ✅ 完整 |
| `traditional/did.py` | `stata/traditional/05_did.do` | ✅ 完整 |
| `traditional/rd.py` | `stata/traditional/06_rd.do` | ✅ 完整 |
| `traditional/psm.py` | `stata/traditional/07_psm.do` | ✅ 完整 |
| `traditional/event_study.py` | `stata/traditional/08_event_study.do` | ✅ 完整 |
| `traditional/garch.py` | `stata/traditional/09_garch.do` | ✅ 完整 |
| `traditional/var.py` | `stata/traditional/10_var.do` | ✅ 完整 |
| `traditional/synthetic_control.py` | `stata/traditional/11_synthetic_control.do` | ✅ 完整 |
